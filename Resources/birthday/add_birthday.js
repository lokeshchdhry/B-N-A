...
exports.add_birthday=function(){
	var add_birthday_win = Ti.UI.createWindow({title:'Add Birthday'});
	...
	var add_but = Ti.UI.createButton({title:'Add Birthday',top:180,left:'35%'});
	...
	//Add function
	 function add(){
		var xhr = Ti.Network.createHTTPClient({	
		    onload: function onLoad() {
		        ...
		        if((this.status) == 201){
		        	...
		        	toast.show_toast("Birthday added successfully",Ti.UI.NOTIFICATION_DURATION_SHORT);
		        	add_birthday_win.close();
		        }
		    },
		...
		xhr.open("POST", links_keys.create_birthday_url);
...
// 		
	...
	add_birthday_win.add(name_lbl);
	add_birthday_win.add(name_txtfld);
	add_birthday_win.add(date_but);
	add_birthday_win.add(date_lbl);
	add_birthday_win.add(check_box);
	add_birthday_win.add(calendar_lbl);
	add_birthday_win.add(add_but);
	add_birthday_win.open();
};
